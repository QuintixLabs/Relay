...
export const HEARTBEAT_INTERVAL_MS = Number(process.env.HEARTBEAT_INTERVAL_MS || 15000);
export const HEARTBEAT_STALE_MS = Number(process.env.HEARTBEAT_STALE_MS || 35000);
